...
/**
 * Crée un ticket privé. Nom du salon : préfixe texte + ID utilisateur (Discord
 * n'autorise pas fiablement les emojis dans les noms de salons). L'emoji reste
 * visible dans l'embed et le topic du salon.
 */
